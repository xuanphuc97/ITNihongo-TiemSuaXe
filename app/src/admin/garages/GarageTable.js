      ...
      <Container fluid>
        ...
        <Row className="table">
          <ListGroup className="list-group">
            <ListGroup.Item>
              <Row>
                <Col xs={0} md={1} className="d-none d-lg-block tb-title">
                  {" "}
                  id{" "}
                </Col>
                <Col xs={6} md={2} className="tb-title">
                  {" "}
                  Name{" "}
                </Col>
                <Col xs={6} md={5} className="tb-title">
                  {" "}
                  Address{" "}
                </Col>
                <Col xs={6} md={2} className="tb-title">
                  ...
                  return (
                    <ListGroup.Item key={`list-garage${idx}`}>
                      <Row>
                        ...
                        <Col xs={6} md={5} className="tb-content">
                          {" "}
                          {garage.address}{" "}
                        </Col>
